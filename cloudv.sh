...
## variables used for joining a domain
domain=false
domainHostName="LampHotel"
...
## subscription setup for red hat
if (( $my_id == "rhel" )) ; then
...
if (( -e "/etc/yum" )) ; then
	...
	sudo $yap -y install php httpd mariadb-server mariadb
